...
class IndexMask {
 ...
 public:
   ...
   * duplicates.
   */
  IndexMask(Span<int32_t> indices) : indices_(indices)
  {
#ifdef DEBUG
   ...
   */
  IndexMask(const std::initializer_list<int32_t> &indices) : IndexMask(Span<int32_t>(indices))
  {
  }
   ...
   */
  explicit IndexMask(int32_t n) : IndexMask(IndexRange(n))
  {
  }

  operator Span<int32_t>() const
  {
    return indices_;
  }
