...
static void node_group_instance_id_build_mf_network(bke::NodeMFNetworkBuilder &builder)
{
...
void register_node_type_fn_group_instance_id()
{
  ...
  ntype.build_mf_network = blender::node::node_group_instance_id_build_mf_network;
