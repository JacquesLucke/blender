      ...
      switch (data->operation) {
        case NODE_COMPARE_LESS_THAN: {
          static fn::CustomMF_SI_SI_SO<float, float, bool> fn{
              "Less Than", [](float a, float b) { return a < b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_LESS_EQUAL: {
          static fn::CustomMF_SI_SI_SO<float, float, bool> fn{
              "Less Equal", [](float a, float b) { return a <= b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_GREATER_THAN: {
          static fn::CustomMF_SI_SI_SO<float, float, bool> fn{
              "Greater Than", [](float a, float b) { return a > b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_GREATER_EQUAL: {
          static fn::CustomMF_SI_SI_SO<float, float, bool> fn{
              "Greater Equal", [](float a, float b) { return a >= b; }, devi_all};
          return &fn;
        }
      ...
      switch (data->operation) {
        case NODE_COMPARE_LESS_THAN: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Less Than", [](int a, int b) { return a < b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_LESS_EQUAL: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Less Equal", [](int a, int b) { return a <= b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_GREATER_THAN: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Greater Than", [](int a, int b) { return a > b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_GREATER_EQUAL: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Greater Equal", [](int a, int b) { return a >= b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_EQUAL: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Equal", [](int a, int b) { return a == b; }, devi_all};
          return &fn;
        }
        case NODE_COMPARE_NOT_EQUAL: {
          static fn::CustomMF_SI_SI_SO<int, int, bool> fn{
              "Not Equal", [](int a, int b) { return a != b; }, devi_all};
          return &fn;
        }
      }
      break;
