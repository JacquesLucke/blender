...
static const fn::MultiFunction *get_multi_function(bNode &bnode)
{
  ...
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> and_fn{
      "And", [](bool a, bool b) { return a && b; }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> or_fn{
      "Or", [](bool a, bool b) { return a || b; }, devi_preset};
  static fn::CustomMF_SI_SO<bool, bool> not_fn{"Not", [](bool a) { return !a; }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> nand_fn{
      "Not And", [](bool a, bool b) { return !(a && b); }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> nor_fn{
      "Nor", [](bool a, bool b) { return !(a || b); }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> xnor_fn{
      "Equal", [](bool a, bool b) { return a == b; }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> xor_fn{
      "Not Equal", [](bool a, bool b) { return a != b; }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> imply_fn{
      "Imply", [](bool a, bool b) { return !a || b; }, devi_preset};
  static fn::CustomMF_SI_SI_SO<bool, bool, bool> nimply_fn{
      "Subtract", [](bool a, bool b) { return a && !b; }, devi_preset};
