...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  b.add_input<decl::Float>(N_("Value")).field_on_auto().hide_value();
  b.add_input<decl::Vector>(N_("Value"), "Value_001").field_on_auto().hide_value();
  b.add_input<decl::Color>(N_("Value"), "Value_002").field_on_auto().hide_value();
  b.add_input<decl::Int>(N_("Value"), "Value_003").field_on_auto().hide_value();
  b.add_input<decl::Bool>(N_("Value"), "Value_004").field_on_auto().hide_value();
}
