...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  b.add_input<decl::Vector>(N_("Value")).field_on_auto();
  b.add_input<decl::Float>(N_("Value"), "Value_001").field_on_auto();
  b.add_input<decl::Color>(N_("Value"), "Value_002").field_on_auto();
  ...
  b.add_output<decl::Bool>(N_("Attribute"), "Attribute_003").field_on_auto();
  b.add_output<decl::Int>(N_("Attribute"), "Attribute_004").field_on_auto();
}
