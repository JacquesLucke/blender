...
void BKE_asset_metadata_catalog_path_set(struct AssetMetaData *asset_data,
                                         const char *catalog_path);
const char *BKE_asset_metadata_catalog_path_get(const struct AssetMetaData *asset_data);
