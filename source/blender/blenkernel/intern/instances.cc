...
blender::Span<int> Instances::instance_reference_handles() const
{
  return instance_reference_handles_;
}

blender::MutableSpan<int> Instances::instance_reference_handles()
{
  return instance_reference_handles_;
}

blender::MutableSpan<blender::float4x4> Instances::instance_transforms()
{
  return instance_transforms_;
}
blender::Span<blender::float4x4> Instances::instance_transforms() const
{
  return instance_transforms_;
}
...
void Instances::remove_instances(const IndexMask mask)
{
  using namespace blender;
