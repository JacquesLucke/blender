...
void *MEM_lockfree_direct_mallocN(size_t len,
                                  size_t alignment,
                                  const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
void *MEM_lockfree_direct_callocN(size_t len,
                                  size_t alignment,
                                  const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
void *MEM_lockfree_direct_reallocN(void *ptr,
                                   ...
                                   const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(2) ATTR_NONNULL(6);
void MEM_lockfree_direct_freeN(void *ptr, size_t alignment);
...
void *MEM_guarded_mallocN_aligned(size_t len,
                                  ...
                                  const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
void *MEM_guarded_direct_mallocN(size_t len,
                                 size_t alignment,
                                 const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
void *MEM_guarded_direct_callocN(size_t len,
                                 size_t alignment,
                                 const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
void *MEM_guarded_direct_reallocN(void *ptr,
                                  ...
                                  const char *str) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT
    ATTR_ALLOC_SIZE(2) ATTR_NONNULL(6);
void MEM_guarded_direct_freeN(void *ptr, size_t alignment);
